...
public class ResponseDayObj {
    ...
    @SerializedName("list")
    @Expose
    private java.util.List<ResponseDayObj.List> list = null;
    @SerializedName("city")
    @Expose
    private City city;
    ...
    public java.util.List<ResponseDayObj.List> getList() {
        return list;
    }

    public void setList(java.util.List<ResponseDayObj.List> list) {
        this.list = list;
    }
